...
# path= 'Data/Input/England/main_players_df.csv'
...
competitions= ['GB1', 'L1', 'IT1', 'FR1', 'ES1']
data_frames=[]
for i in competitions:
    country= Clubs (f'{i}', '2022', '2023')
    country= country.club_dataframe()
    data_frames.append(country)
data_frame= pd.concat(data_frames)
data_frame.to_csv('Data/Input/Other/clubs_md.csv')
